// The two-tone brand mark: a white bubble with the handset knocked out of it in
// green. Self-contained on purpose — it reads the same on the green pills, on
// the black submit button and on the dark footer, without a colour prop.
