...
import { ChevronIcon, GoogleIcon } from "@/components/Icons";
...
// Deliberately not the shared StarIcon: this path differs slightly from the one
// Hero uses, and unifying them would change how the stars render.
// TODO: pick one drawing and use it in both places.
function StarIcon() {
  return (
