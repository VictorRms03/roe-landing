      ...
      <section id="clinicas" className="scroll-mt-32 bg-roe-yellow px-6 py-12 md:px-12 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          <ul className="mt-10 grid gap-10 md:grid-cols-2">
            {UNITS.map((unit) => (
              <li key={unit.name} className="rounded-2xl bg-[#FFFCF5] shadow-lg shadow-black/10">
                ...
                <div className="relative p-6 pt-4">
                  ...
                  {unit.whatsapp && (
                    <a
                      ...
                      className="absolute bottom-3 right-3 flex size-12 shrink-0 items-center justify-center rounded-full bg-[#25d366] outline-none transition-transform duration-200 hover:scale-105 focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2 focus-visible:ring-offset-[#FFFCF5]"
                    >
